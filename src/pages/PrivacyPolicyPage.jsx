...
const PrivacyPolicyPage = () => {
    ...
    return (
        <div className="central-box">
            ...
            <div className="dashboard-info" style={{padding: "15px 10% 15px 10%;"}}>
                ...
                <div>
                    ...
                    <ul style={{ listStyleType: 'disc', marginLeft: '20px', marginTop: '10px', lineHeight: '1.6' }}>
                        ...
                        <li><span className='bold-text'>Email di contatto:</span> <a href={`mailto:${Titolare.email}`} style={{fontWeight: 'bold', textDecoration: 'none', color:"#ef7821" }} className="policy-link">{Titolare.email}</a></li>
                    </ul>
                </div>
                ...
                <p style={{ marginBottom: '1rem' }}>
                    In qualità di utente, puoi esercitare i seguenti diritti in qualsiasi momento, inviando una richiesta all'indirizzo email del Titolare: <strong><a href={`mailto:${Titolare.email}`} style={{ fontWeight: 'bold', textDecoration: 'none', color:"#ef7821" }}>{Titolare.email}</a></strong>.
                </p>
